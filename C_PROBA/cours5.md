...
Il faut qu'on prouve que la proba $P(|\overline{X_n}| \geq \varepsilon) \underset{n \mapsto +\infty}{\overset{P}{\longrightarrow}} 0$
...
- Montrer que $U_n \underset{n \mapsto +\infty}{\overset{\mathscr{L}}{\longrightarrow}} 0$
...
Or $\begin{align}\frac{x}{n} > 1 &\implies f_n(t) = 0\ si\ t > 1  \\&\implies P(Y_n \leq x) = \int^1_0 f_n(t) dt = 1\end{align}$

Donc la fonction de repartition de $Y_n$ est

$F_n(x) = \begin{cases}0\ si\  x< 0 \\ 1 - (1 - \frac{x}{n})^{n+1}\ si\ 0 \leq x \leq n \\ 1\ si\ x > n \end{cases}$
